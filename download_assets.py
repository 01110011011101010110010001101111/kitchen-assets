...
DOWNLOAD_ASSET_REGISTRY = dict(
    textures=dict(
        ...
        folder=("robocasa/models/assets/textures"),
    ...
    generative_textures=dict(
        ...
        folder=("robocasa/models/assets/generative_textures"),
        check_folder_exists=False,
    ),
)
